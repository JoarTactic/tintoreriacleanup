...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header" style="background-color:aqua;">{{ __('Empleados - registro') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" accept-charset="UTF-8" action="{{ route('empleadosStore') }}">
                            @csrf
                            <div class="row">
