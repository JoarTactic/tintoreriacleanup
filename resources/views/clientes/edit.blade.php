            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" accept-charset="UTF-8" action="{{ route('clientesUpdate', ['id' => $cliente->id]) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-12 col-md-12">
                                    ...
                                    <input type="text" class="form form-control" title="@lang("Nombre completo")" required
                                           placeholder="@lang("Nombre completo")" value="{{ $cliente->nombreCompleto }}" name="nombreCompleto"
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <input type="number" class="form form-control" title="@lang("Teléfono")" required
                                           placeholder="@lang("Teléfono")" value="{{ $cliente->telefono }}" name="telefono" id="telefono"
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <input type="email" class="form form-control" title="@lang("Correo electrónico")"
                                           required placeholder="@lang("Correo electrónico")" value="{{ $cliente->correo }}" name="correo"
