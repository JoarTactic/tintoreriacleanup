...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header" style="background-color:aqua;">{{ __('Prendas - edición') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" accept-charset="UTF-8" action="{{ route('prendasUpdate', ['id' => $prenda->id]) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-12 col-md-12">
                                    ...
                                    <input type="text" class="form form-control" title="@lang("Nombre")" required
                                           placeholder="@lang("Nombre")" value="{{ $prenda->nombre }}" name="nombre"
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <input type="text" class="form form-control" title="@lang("Precio por prenda lavada")" required
                                           placeholder="@lang("Precio por prenda lavada")" value="{{ $prenda->precioPorPrenda }}" name="precioPorPrenda" id="precioPorPrenda"
                                ...
                                <div style="display: none;" class="col-12 col-md-12">
                                    ...
                                    <input type="text" class="form form-control" title="@lang("Precio por kilo")" required
                                           placeholder="@lang("Precio por kilo")" value="{{ $prenda->precioPorKilo }}" name="precioPorKilo" id="precioPorKilo"
        ...
        precioPorKilo.value = input.value;
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <input type="text" class="form form-control" title="@lang("Precio por prenda planchada")" required
                                           placeholder="@lang("Precio por prenda planchada")" value="{{ $prenda->precioPlanchado }}" name="precioPlanchado" id="precioPlanchado"
                                           minlength="1" maxlength="6">
