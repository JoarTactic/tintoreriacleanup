...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('images/logoclean.ico')); ?>" type="image/x-icon">

    <title><?php echo e(config('app.name', 'Clean Up')); ?></title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm"
             style="background-image:url('<?php echo e(asset('images/vector2.png')); ?>')">
            <div class="container">
                <?php if(auth()->guard()->guest()): ?>
                    <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                        <img src="<?php echo e(asset('images/logoclean2.png')); ?>" title="<?php echo e(config('app.name', 'Clean Up')); ?>"
                             alt="<?php echo e(config('app.name', 'Clean Up')); ?>" height="30px;">
                    </a>
                <?php else: ?>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <?php if(Route::has('login')): ?>
                                <li class="nav-item">
                                    <a class="nav-link btn btn-light" href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></a>
                                </li>
                            <?php endif; ?>
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link btn btn-light" href="<?php echo e(route('home')); ?>" role="button"
                                   style="color:black; border-color:#cbd5e0;">
                                    <?php echo app('translator')->get("Ordenes"); ?>
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link btn btn-light" href="<?php echo e(route('ordenes')); ?>" role="button"
                                   style="color:black; border-color:#cbd5e0;">
                                    <?php echo app('translator')->get("Crear orden"); ?>
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link btn btn-light" href="<?php echo e(route('clientes')); ?>" role="button"
                                   style="color:black; border-color:#cbd5e0;">
                                    <?php echo app('translator')->get("Clientes"); ?>
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link btn btn-light" href="<?php echo e(route('empleados')); ?>" role="button"
                                   style="color:black; border-color:#cbd5e0;">
                                    <?php echo app('translator')->get("Empleados"); ?>
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link btn btn-light" href="<?php echo e(route('prendas')); ?>" role="button"
                                   style="color:black; border-color:#cbd5e0;">
                                    <?php echo app('translator')->get("Prendas y precios"); ?>
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel"><?php echo app('translator')->get("Confirmación"); ?></h5>
                            <button type="button" class="close closeModal" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <?php echo app('translator')->get("¿Esta seguro de eliminar este registro?"); ?>
                            <br>
                        ...
                        <div class="modal-footer">
                            <form action="" method="post" id="MyFormDelete">
                                ...
                                <button type="button" class="btn btn-secondary closeModal" data-dismiss="modal"><?php echo app('translator')->get("Cancelar"); ?></button>
                                <button type="submit" class="btn btn-primary"><?php echo app('translator')->get("Eliminar"); ?></button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/MyDataTable.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/MyModal.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/InputMask.js')); ?>"></script>
    <?php echo $__env->yieldContent('scripts'); ?>
</body>
</html>
<?php /**PATH C:\Users\victor.arrollo\Downloads\lavanderiacleanup_V2\resources\views/layouts/app.blade.php ENDPATH**/ ?>