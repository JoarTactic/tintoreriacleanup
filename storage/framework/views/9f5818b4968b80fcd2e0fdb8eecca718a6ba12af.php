<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header" style="background-color:aqua;"><?php echo e(__('Prendas - registro')); ?></div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" accept-charset="UTF-8" action="<?php echo e(route('prendasStore')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-12 col-md-12">
                                    ...
                                    <input type="text" class="form form-control" title="<?php echo app('translator')->get("Nombre"); ?>" required
                                           placeholder="<?php echo app('translator')->get("Nombre"); ?>" value="" name="nombre"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <input type="text" class="form form-control" title="<?php echo app('translator')->get("Precio por prenda lavada"); ?>" required
                                           placeholder="<?php echo app('translator')->get("Precio por prenda lavada"); ?>" value="" name="precioPorPrenda" id="precioPorPrenda"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div style="display: none;" class="col-12 col-md-12">
                                    ...
                                    <input type="text" class="form form-control" title="<?php echo app('translator')->get("Precio por kilo"); ?>" required
                                           placeholder="<?php echo app('translator')->get("Precio por kilo"); ?>" value="" name="precioPorKilo" id="precioPorKilo"
        ...
        precioPorKilo.value = input.value;
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <input type="text" class="form form-control" title="<?php echo app('translator')->get("Precio por prenda planchada"); ?>" required
                                           placeholder="<?php echo app('translator')->get("Precio por prenda planchada"); ?>" value="" name="precioPlanchado" id="precioPlanchado"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\victor.arrollo\Downloads\lavanderiacleanup_V2\resources\views/prendas/create.blade.php ENDPATH**/ ?>